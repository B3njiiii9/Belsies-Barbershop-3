            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="classic-fade">Classic Fade (KSH 400)</option>
                  <option value="luxury-beard">Luxury Beard Trim (KSH 250)</option>
                  <option value="full-service">Full Service (KSH 2800)</option>
                  <option value="massage">Massage (KSH 1700)</option>
                  <option value="Hair Dye">Hair Dye (KSH 800)</option>
                  <option value="kids-haircut">Kid's Haircut (KSH 300)</option>
                </select>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
